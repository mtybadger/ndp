...
class ImageLogger(Callback):
    ...
    def log_img(self, pl_module, batch, batch_idx, split="train"):
        if (self.check_frequency(batch_idx) and  # batch_idx % self.batch_freq == 0
            ...
            self.log_local('/shared/imagenet/logs_single/', split, images,
...
class MyLightningCLI(LightningCLI):
    ...
    def after_instantiate_classes(self):
        ...
        self.trainer.logger = WandbLogger(project="vqgan")
        
        # configure learning rate
        bs, base_lr = datamodule.batch_size, 4.5e-6
        ...
        trainer.callbacks.append(ImageLogger(batch_frequency=5000, max_images=4, clamp=True))
...
def main():
    ...
    MyLightningCLI(
        model_class=VQModel,        # or a wrapper that calls instantiate_from_config
        ...
        trainer_defaults={
            ...
            "max_epochs": 40,
            "default_root_dir": "/shared/imagenet/vqgan_logs_single",
            "precision": "16-mixed",
            "devices": 8,
