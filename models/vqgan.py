...
class VQMultiModel(pl.LightningModule):
    def __init__(self,
        ...
        self.encoder_1 = Encoder(**ddconfig, ch_mult=[1,2,2,2], in_channels=3, out_ch=3, z_channels=z_channels, resolution=128, attn_resolutions=[16])
        ...
        self.decoder = Decoder(**ddconfig, ch_mult=[1,2,2,2], in_channels=z_channels * 4, out_ch=3, z_channels=z_channels * 4, resolution=128, attn_resolutions=[16])
