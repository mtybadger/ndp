...
class ImageLogger(Callback):
    ...
    def log_img(self, pl_module, batch, batch_idx, split="train"):
        if (self.check_frequency(batch_idx) and  # batch_idx % self.batch_freq == 0
            ...
            self.log_local('/shared/imagenet/multi_logs_mono/', split, images,
...
def main():
    ...
    MyLightningCLI(
        ...
        trainer_defaults={
            "callbacks": [
                ModelCheckpoint(save_top_k=-1, every_n_epochs=1, save_last=True, dirpath="/shared/imagenet/vqgan_multi_mono_logs"),
            ...
            "max_epochs": 50,
            "default_root_dir": "/shared/imagenet/vqgan_multi_mono_logs",
